    ...
    <Card className="border-border/50 mb-8 bg-card/50 backdrop-blur-sm">
      ...
      <CardContent className="space-y-3 lg:space-y-4">
       {finalNotificationFix.map((notification) => (
        <div className="w-full flex justify-between items-center p-2 rounded-lg" key={notification.id}>
            <div className="w-full flex gap-2 items-center">
              ...
              <div className="flex flex-col gap-1 ">
                  <h1 className="text-sm font-bold text-muted-foreground">{notification.title}</h1>
